<template>
      ...
      <el-container>
        <el-header class = "bg-white m-4 rounded-md shadow-lg ">
          <el-menu ellipsis-icon mode = "horizontal" :popper-offset = "16"
            ...
            <div>
              <p class = "font-bold text-2xl text-cyan-500 ">ERP SYSTEM</p>
            </div>
  ...
  <el-tour v-model = "open">
    ...
    <el-tour-step title = "Thanh điều hướng"
                  description = "Đây là thanh điều hướng, nơi bạn truy cập các chức năng chính của hệ thống."
                  placement = "right"
                  :target = "asideBar?.$el" />
...
import {ChatDotRound, Notification, QuestionFilled, Refresh, Search} from '@element-plus/icons-vue'
import type {AsideInstance, ButtonInstance, InputInstance, MainInstance} from 'element-plus'
